...
public final class DiagramViewer
{
    private final static List<Color> COLORS =
 	    Arrays.asList(Color.BLACK, Color.RED, Color.GREEN, Color.BLUE,
 	...
 	return new Text(rnd.nextInt(400), rnd.nextInt(400), 10,getRandomColor(),"HEJ PÅ DIG");
     }
